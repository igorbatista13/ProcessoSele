                        ...
                        <div class="flex justify-between">
                            <div class="w-1/2">
                                <button
                                    x-show="step > 1"
                                    @click="step--"
                                    class="w-62 focus:outline-none py-2 px-5 rounded-lg shadow-sm text-center text-gray-600 bg-white hover:bg-gray-100 font-medium border" 
                                >Voltar</button>
                            </div>
                            ...
                            <div class="w-1 text-right">
                                <button
                                    x-show="step < 3"
                                    @click="step++"
                                    class="w-62 focus:outline-none border border-transparent py-2 px-5 rounded-lg shadow-sm text-center text-white bg-blue-500 hover:bg-blue-600 font-medium" 
                                >Próximo</button>
